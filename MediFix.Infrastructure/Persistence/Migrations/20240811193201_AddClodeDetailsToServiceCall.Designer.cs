...
namespace MediFix.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240811193201_AddClodeDetailsToServiceCall")]
    partial class AddClodeDetailsToServiceCall
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryExpertise", b =>
                {
                    b.Property<Guid>("AllowedExpertisesId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CategoriesId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("AllowedExpertisesId", "CategoriesId");

                    b.HasIndex("CategoriesId");

                    b.ToTable("CategoryExpertise", (string)null);
                });
            ...
            modelBuilder.Entity("MediFix.Domain.Expertises.Expertise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MediFix.Domain.ServiceCalls.ServiceCall", b =>
                {
                    ...
                    b.Property<string>("CloseDetails")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CategoryExpertise", b =>
                {
                    b.HasOne("MediFix.Domain.Expertises.Expertise", null)
                        .WithMany()
                        .HasForeignKey("AllowedExpertisesId")
